...
const PaymentConfirm = () => {
  return (
    <div className="flex flex-col items-center justify-center px-5 mt-8 mb-32">
      ...
      <Link
        href="/"
        className="px-4 py-2 mt-6 text-white rounded-md mb-28 bg-primary hover:scale-105 duration-300"
      >
        Go to Home
      </Link>
    </div>
